"""Static HTML builder for the Faceless Income Engine landing page.
Generates a self-contained HTML file at offer/landing/index.html
for deployment on Cloudflare Pages / GitHub Pages / Netlify.
"""

from pathlib import Path

OUTPUT_DIR = Path(__file__).parent / "landing"
...
<meta name="twitter:title" content="The Faceless Income Engine">
<meta name="twitter:description" content="Automated Content to Warm Traffic to Silent Sales. Zero face, zero voice, zero overhead.">
<!--
...
<!--
  Form action: when deploying on Cloudflare Pages / Netlify,
  change the action URL to your backend endpoint or use a serverless function.
  Examples:
    action="https://your-api.workers.dev/subscribe"
    action="https://yourdomain.com/api/subscribe"
-->
...
def build():
    ...
    print(f"Landing page written to {OUTPUT_FILE}")
